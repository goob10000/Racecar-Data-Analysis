...
file = "C:\Projects\FormulaSlug\9dof-sparkfun-datalogger\Runs\Rectangle2x.csv"
rawData = pl.read_csv(file) #Read in trip csv
rawData.columns = ['time', 'voltage', 'state_of_charge', 'charge_rate', #Renames all the columns with these headers which are easier to type
        'xAcc', 'yAcc', 'zAcc', 
        'xGyro', 'yGyro', 'zGyro', 'ISM330.temp', 
       'xBField', 'yBField', 'zBField', 'MMC5983.temp']
SIFrame = pl.DataFrame(rawData["time"]/1000) #s
